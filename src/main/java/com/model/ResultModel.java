...
public class ResultModel extends HashMap<String,Object> {
    ...
    public static final String KEY_OPER = "oper";//执行的操作
    public static final String KEY_SUCC = "succ";//是否成功
    public static final String KEY_CODE = "code";//操作结果的代码
    public static final String KEY_MSG = "msg";//操作结果的信息
    public static final String KEY_DATA = "data";//操作的数据
